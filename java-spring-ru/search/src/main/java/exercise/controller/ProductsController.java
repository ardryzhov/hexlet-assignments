...
public class ProductsController {
    ...
    public List<ProductDTO> index(ProductParamsDTO productParamsDTO,
                                  @RequestParam(defaultValue = "1") int page) {
        var specBuilder = specification.build(productParamsDTO);

        var entity = productRepository.findAll(specBuilder, PageRequest.of(page - 1, 10));
